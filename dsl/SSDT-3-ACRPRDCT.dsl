 ...
 *
 * Disassembly of SSDT-3-ACRPRDCT.aml, Thu Sep 27 10:22:51 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003B8C (15244)
 *     Revision         0x01
 *     Checksum         0xDE
 *     OEM ID           "ACRSYS"
            ...
            Method (WKAR, 0, Serialized)
            {
                ...
                Switch (Local0)
                {
                    ...
                    Case (0x03)
                    {
                        ...
                        ElseIf (LEqual (CDDS (0x80000400), 0x1F))
                        {
                            WPCH (0x02, Zero)
                        }
                        ElseIf (LEqual (CDDS (0x80000100), 0x1F))
                        {
                            WPCH (One, Zero)
                        }
                    }
                    Case (0x05)
                    {
                        ...
                        ElseIf (LEqual (CDDS (0x80007334), 0x1F))
                        {
                            WPCH (One, Zero)
                        }
                    }
                    Case (0x07)
                    {
                        ...
                        ElseIf (LAnd (LEqual (CDDS (0x80000400), 0x1F), LEqual (CDDS (0x80007334), 0x1F)))
                        {
                            WPCH (0x04, Zero)
                        }
                        ElseIf (LAnd (LEqual (CDDS (0x80000100), 0x1F), LEqual (CDDS (0x80007334), 0x1F)))
                        {
                            WPCH (0x03, Zero)
                        }
                        ElseIf (LEqual (CDDS (0x80000100), 0x1F))
                    ...
                    Case (0x09)
                    {
                        ...
                        ElseIf (LEqual (CDDS (0x80006330), 0x1F))
                        {
                            WPCH (One, One)
                        }
                    }
                    Case (0x0D)
                    {
                        If (LAnd (LEqual (CDDS (0x80000400), 0x1F), LAnd (LEqual (CDDS (0x80007334), 0x1F), LEqual (CDDS (0x80006330), 0x1F))))
                        {
                            WPCH (0x05, One)
                        }
                        ElseIf (LAnd (LEqual (CDDS (0x80000400), 0x1F), LEqual (CDDS (0x80007334), 0x1F)))
                        ...
                        ElseIf (LAnd (LEqual (CDDS (0x80000400), 0x1F), LEqual (CDDS (0x80006330), 0x1F)))
                        {
                            WPCH (0x06, One)
                        }
                        ElseIf (LEqual (CDDS (0x80007334), 0x1F))
                    ...
                    Case (0x11)
                    {
                        ...
                        ElseIf (LEqual (CDDS (0x80006332), 0x1F))
                        {
                            WPCH (One, 0x02)
                        }
                    }
                    Case (0x15)
                    {
                        If (LAnd (LEqual (CDDS (0x80000400), 0x1F), LAnd (LEqual (CDDS (0x80007334), 0x1F), LEqual (CDDS (0x80006332), 0x1F))))
                        {
                            WPCH (0x05, 0x02)
                        }
                        ElseIf (LAnd (LEqual (CDDS (0x80000400), 0x1F), LEqual (CDDS (0x80007334), 0x1F)))
                        ...
                        ElseIf (LAnd (LEqual (CDDS (0x80000400), 0x1F), LEqual (CDDS (0x80006332), 0x1F)))
                        {
                            WPCH (0x06, 0x02)
                        }
                        ElseIf (LEqual (CDDS (0x80007334), 0x1F))
