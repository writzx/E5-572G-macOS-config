 ...
 *
 * Disassembly of SSDT-x2_1-Cpu0Cst.aml, Thu Sep 27 10:22:52 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000465 (1125)
 *     Revision         0x01
 *     Checksum         0x3D
 *     OEM ID           "PmRef"
        ...
        Method (_CST, 0, Serialized)  // _CST: C-States
        {
            If (LNot (CSTF))
            {
                ...
                If (LAnd (And (CFGD, 0x0800), And (PDC0, 0x0200)))
                {
                    ...
                    Store (C7MW, Index (DerefOf (Index (C7T2, Zero)), 0x07))
